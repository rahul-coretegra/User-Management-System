...
namespace User_Management_System.ManagementModels.VMs
{
    ...
    public class PsqlUserVM
    {
        ...
        public List<PostgreSqlModels.UserAndRoles> UserAndRoles { get; set; }
    ...
    public class MssqlUserVM
    {
        ...
        public List<MicrosoftSqlServerModels.UserAndRoles> UserAndRoles { get; set; }
    ...
    public class MongoDBUserVM
    {
        ...
        public List<MongoDbModels.UserAndRoles> UserAndRoles { get; set; }
